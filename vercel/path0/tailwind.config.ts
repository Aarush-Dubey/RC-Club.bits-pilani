 ...
 * It defines the design system, including color palettes, font sizes, border radii, and keyframe animations.
 * Custom theme extensions allow for a consistent look and feel that aligns with the application's branding,
 * and it is set up to support dark mode.
 */
