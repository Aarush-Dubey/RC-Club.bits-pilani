/**
 * This file defines the OverviewMetrics component, which displays a set of
 * key performance indicators (KPIs) on the dashboard. It shows metrics like
 * active projects, items on loan, and pending reimbursements in a series of
 * styled cards, giving a quick snapshot of the club's status.
 */
import {
  Card,
  CardContent,
