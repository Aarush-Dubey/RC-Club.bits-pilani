/**
 * This file defines the KeyStatus component, which displays the current holder
 * of various club keys. It allows the current key holder to initiate a transfer
 * to another eligible member, showing a dialog with a list of recent transfers
 * for that key to provide context.
 */
"use client";
