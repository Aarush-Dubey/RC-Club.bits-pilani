/**
 * This file defines the MyInventory component, which displays a list of items
 * that the currently logged-in user has either requested or has on loan. It
 * shows the status of each item and provides a button for the user to initiate
 * the return process for fulfilled, non-perishable items.
 */
"use client"
