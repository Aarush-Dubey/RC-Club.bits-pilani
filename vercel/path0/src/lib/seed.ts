/**
 * This file is a script for seeding the Firestore database with initial data.
 * It contains sample data for users, projects, inventory, requests, and financial records.
 * The `seedDatabase` function iterates through this data and populates the corresponding Firestore collections,
 * making it useful for setting up a fresh development or test environment.
 */
