 ...
 * It provides a `useAuth` hook that allows components to access the current user's
 * authentication state, including their profile information, role, and permissions.
 * The `AuthProvider` component wraps the application and handles fetching and updating
 * this user data from Firebase Authentication and Firestore.
 */
"use client"
